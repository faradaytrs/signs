...
(function() {
  ...
  reRender = function(stage, model) {
      var id, k, padding, paddingText, rect, rectKonva, shapeLayer, signBeginX, signBeginY, signHeight, signWidth, sizes, text, textBeginX, textBeginY, textHeight, textKonva, textLayer, textWidth, top, _i, _len, _ref;
    clearStage(stage);
