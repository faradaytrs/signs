...
(function() {
  var array2Object, clearStage, copyObj, createText, createText2, getBalancingCoefficient, getModels, getSizesTexts, getSpace, getTextHeight, getTextWidth, modelTemplate, models, reRender, reRender_, roundRect, saveModels, settings, signs, simpleCreateText, simpleRect;
  ...
  reRender = function(stage, model) {
    var id, j, k, len, padding, paddingText, rect, rectKonva, ref, shapeLayer, signBeginX, signBeginY, signHeight, signWidth, sizes, text, textBeginX, textBeginY, textHeight, textKonva, textLayer, textWidth, top;
    clearStage(stage);
